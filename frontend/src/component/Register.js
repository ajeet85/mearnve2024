...
export default function Register() {
  ...
  phone: '',
  website: '',
  location: '', // State for dropdown value
  interestArea: '', // State for dropdown value
  message: '' };
  ...
  const validate = (values) => {
    ...
    if (!values.location) {
      errors.location = 'Location is required'; // Add validation for location dropdown
    }
    if (!values.interestArea) {
      errors.interestArea = 'Interest Area is required'; // Add validation for interest area dropdown
    }
  ...
  useEffect(() => {
    const singleContent = contentList.find((ele) => ele.menu === 'register');
            ...
            {postData && (
              ...
              <form onSubmit={handleSubmit} encType="multipart/form-data">
                <div className="register-form-section">
                  ...
                  <div className="register-form-row">
                    <div className="register-form-left">Website</div>
                    <div className="register-form-right">

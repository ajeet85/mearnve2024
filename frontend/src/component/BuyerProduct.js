...
export default function BuyerProduct() {
    ...
    useEffect(() => {
      const singleContent = contentList.find((ele) => ele.menu === 'buyer_product');
            ...
            <section className="tabs-section buyer-product-tab-wrapper">
                <div className="container">
                    <ul className="nav nav-tabs">
                        ...
                        <Link onClick={() => handleTabClick('tab-one')} className="reverse-tab-icon">Reverse Factoring</Link>
                        </li>
                        <li className={isActiveTab('tab-two') ? 'active' : ''}>
                        <Link onClick={() => handleTabClick('tab-two')} className="dynamic-discount-tab-icon">Dynamic Discounting</Link>
                        </li>
                    </ul>
                </div>

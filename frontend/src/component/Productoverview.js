...
export default function Productoverview() {
  ...
  useEffect(() => {
    const singleContent = contentList.find((ele) => ele.menu === 'overview');
  ...
  return (
    <div className='websiteApp'>
     ...
     {postData && (
                  <>
                  <section className="banner-section mobile-banner" style={{background: `url(${'/uploads/'+postData.image}) no-repeat`}}>
